...
class MyStruct(asn1.Sequence):
    def __init__(self, source=None):
        ...
        self.aType = _aType
        self.a: _aType.__typing__ = self.aType()
        ...
        self.bType = _bType
        self.b: _bType.__typing__ = self.bType()
        ...
        self.cType = _cType
        self.c: _cType.__typing__ = self.cType()
...
class MyChoice(asn1.Choice):
    def __init__(self, choice=None):
        ...
        self.alpha: _alphaType.__typing__ = self.alphaType()
        ...
        self.beta: _betaType.__typing__ = self.betaType()
        ...
        self.octStr: _octStrType.__typing__ = self.octStrType()
...
class MySqOf(asn1.SequenceOf):
    class _ElementType(asn1.Sequence):
        def __init__(self, source=None):
            ...
            self.a2Type = _a2Type
            self.a2: _a2Type.__typing__ = self.a2Type()
            ...
            self.b2Type = _b2Type
            self.b2: _b2Type.__typing__ = self.b2Type()
            ...
            self.c2Type = _c2Type
            self.c2: _c2Type.__typing__ = self.c2Type()
...
class AComplexMessage(asn1.Sequence):
    def __init__(self, source=None):
        ...
        self.intVal: _intValType.__typing__ = self.intValType()
        ...
        self.int2Val: _int2ValType.__typing__ = self.int2ValType()
        ...
        self.int3Val: _int3ValType.__typing__ = self.int3ValType()
        ...
        self.strVal: _strValType.__typing__ = self.strValType()
        ...
        self.intArray: _intArrayType.__typing__ = self.intArrayType()
        ...
        self.realArray: _realArrayType.__typing__ = self.realArrayType()
        ...
        self.octStrArray: _octStrArrayType.__typing__ = self.octStrArrayType()
        ...
        self.enumArray: _enumArrayType.__typing__ = self.enumArrayType()
        ...
        self.enumValue: _enumValueType.__typing__ = self.enumValueType()
        ...
        self.enumValue2: _enumValue2Type.__typing__ = self.enumValue2Type()
        ...
        self.label: _labelType.__typing__ = self.labelType()
        ...
        self.bAlpha: _bAlphaType.__typing__ = self.bAlphaType()
        ...
        self.bBeta: _bBetaType.__typing__ = self.bBetaType()
