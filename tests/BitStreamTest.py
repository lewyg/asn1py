...
class BitStreamTest(TestCase):
    ...
    def test_acn_encode_decode_integer_twos_complement_const_size_16_0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_16('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_16_0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_16('little'))

    def test_acn_encode_decode_integer_twos_complement_const_size_16_1234_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(1234, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(1234, self.b2.acn_decode_integer_twos_complement_const_size_16('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_16_1234_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(1234, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(1234, self.b2.acn_decode_integer_twos_complement_const_size_16('little'))
    ...
    def test_acn_encode_decode_integer_twos_complement_const_size_16_face_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(0x7ACE, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x7ACE, self.b2.acn_decode_integer_twos_complement_const_size_16('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_16_face_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_16(0x7ACE, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x7ACE, self.b2.acn_decode_integer_twos_complement_const_size_16('little'))

    def test_acn_encode_decode_integer_twos_complement_const_size_32_0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_32('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_32_0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_32('little'))

    def test_acn_encode_decode_integer_twos_complement_const_size_32_face_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0xFACE, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0xFACE, self.b2.acn_decode_integer_twos_complement_const_size_32('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_32_face_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0xFACE, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0xFACE, self.b2.acn_decode_integer_twos_complement_const_size_32('little'))
    ...
    def test_acn_encode_decode_integer_twos_complement_const_size_32_f0a0c0e0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0x70A0C0E0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x70A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_32('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_32_f0a0c0e0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_32(0x70A0C0E0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x70A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_32('little'))

    def test_acn_encode_decode_integer_twos_complement_const_size_64_0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_64('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_64_0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0, self.b2.acn_decode_integer_twos_complement_const_size_64('little'))

    def test_acn_encode_decode_integer_twos_complement_const_size_64_f0a0c0e0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0xF0A0C0E0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0xF0A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_64('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_64_f0a0c0e0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0xF0A0C0E0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0xF0A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_64('little'))
    ...
    def test_acn_encode_decode_integer_twos_complement_const_size_64_f0a0c0e0f0a0c0e0_big(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0x70A0C0E0F0A0C0E0, 'big')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x70A0C0E0F0A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_64('big'))

    def test_acn_encode_decode_integer_twos_complement_const_size_64_f0a0c0e0f0a0c0e0_little(self):
        self.b.acn_encode_integer_twos_complement_const_size_64(0x70A0C0E0F0A0C0E0, 'little')

        self.b2 = BitStream(self.b)
        self.assertEqual(0x70A0C0E0F0A0C0E0, self.b2.acn_decode_integer_twos_complement_const_size_64('little'))
